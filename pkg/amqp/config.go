...
type PublishConfig struct {
	...
	// the AMQP server in order to guarantee that the message was actually delivered. Setting this value to true may
	// negatively impact performance but increase resiliency.
